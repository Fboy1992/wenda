        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <style type="text/css">
                *{margin:0px; padding:0px;}
                ...
                .hd_error_html h2{ height: 28px; color:#000;background-color:#24ad41;font-size:16px; font-weight: bold; text-indent: 10px; line-height: 1.8em;}
        ...
        <div class="hd_error_html">
            ...
            <div>
                ...
                <span><span id="time"><?php echo $time;?></span><?php echo L("success_html_span1");?>
                    ...
                    <?php echo L("success_html_span3");?><a href="http://localhost/wenda"><?php echo L("success_html_span4");?></a></span>
            </div>
        </div>
        <script type="text/javascript">
