...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            <title><?php echo L("error_html_title");?></title>
            <style type="text/css">
                *{margin:0px; padding:0px;}
                ...
                .hd_error_html h2{ height: 28px; color:#fff;background-color:#24ad41;font-size:16px; font-weight: bold; text-indent: 10px; line-height: 1.8em;}
    ...
    <body>
        <div class="hd_error_html">
            <h2><?php echo L("error_html_hd_error_html_h2");?></h2>
            <div>
                ...
                <span><span id="time"><?php echo $time;?></span><?php echo L("error_html_span1");?>
                    ...
                    <?php echo L("error_html_span3");?><a href="http://localhost/wenda"><?php echo L("error_html_span4");?></a></span>
            </div>
        </div>
        <script type="text/javascript">
