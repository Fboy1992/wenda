...
<head>
	...
	<link rel="stylesheet" href="http://localhost/wenda/Index/Tpl/Public/css/face.css" />
</head>
<body>     
...
<!-- 左侧结束 -->
	<div id='right'>
		...
		<div class='imgface_box'>
			<img src="<?php echo $face;?>" id="preview">
			<form action="<?php echo U('my_face', array('uid'=>$_GET['uid']));?>" method="POST" enctype="multipart/form-data">
