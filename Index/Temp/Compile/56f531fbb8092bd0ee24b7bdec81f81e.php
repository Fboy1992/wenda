...
<!-- 左侧结束 -->
	<div id='right'>
			...
			<p class='lv-info'>恭喜您，已经升到 <span style="color:orange;">LV<?php echo $level;?></span> 级啦，距下一级还需 <span style="color:orange;"><?php echo $nextExp;?></span> 经验值!</p>
			<div class='lv-rule'>
				<p><span>等级规则</span></p>
				<table class='lv-exp'>
					<tr>
					...
					<tr class="cur">
						<td >我的等级是<span style="color:orange;"><?php echo $level;?></span></td>
						<td><span><?php echo $user['exp'];?></span></td>
					</tr>
					<?php if(is_array($levelExp)):?><?php  foreach($levelExp as $k=>$n){ ?>
					<tr>
						<td><?php echo $k;?></td><td><?php echo $n;?></td>
					</tr>
					<?php }?><?php endif;?>
				</table>
			</div>
